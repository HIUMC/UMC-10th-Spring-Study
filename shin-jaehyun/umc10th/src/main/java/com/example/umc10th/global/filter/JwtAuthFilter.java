    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            if (jwtUtil.isValid(token)) {
                ...
                Long uid = jwtUtil.getMemberId(token);
                ...
                if (socialType == SocialType.LOCAL) {
                    ...
                    user = customUserDetailsService.loadUserById(uid);
                } else {
                    user = customUserDetailsService.loadUserByUidAndSocialType(socialType, uid.toString());
                }
