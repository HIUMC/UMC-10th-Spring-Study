package com.example.week4.global.security.util;
...
public class JwtUtil {
    ...
    // AccessToken 생성
    public String createAccessToken(AuthUserDetails userDetails) {
    ...
    // 토큰 생성
    private String createToken(AuthUserDetails member, Duration expiration) {
