...
public class AuthController {
    ...
    public ApiResponse<AuthResDTO.LoginResult> login(@RequestBody @Valid AuthReqDTO.Login request) {
        return ApiResponse.onSuccess(MemberSuccessCode.OK, authService.login(request));
    }
}