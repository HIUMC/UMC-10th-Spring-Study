...
import com.example.mission4.global.security.dto.KakaoDTO;
...
/**
 * 사용자 정보를 가지고 DB에 저장 or 조회하는 서비스
 * OAuth 과정 중 사용자 정보를 가져온 다음 실행된다.
 * (유저 정보 조회) → 유저 정보 추출 → DB 확인 (없으면 새로 저장, 있으면 조회) → 인증 객체 생성
 */
@Service
...
public class CustomOAuthService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(
        ...
        // DB 저장: 있다면 그 데이터를 가져오고, 없으면 새로 저장
